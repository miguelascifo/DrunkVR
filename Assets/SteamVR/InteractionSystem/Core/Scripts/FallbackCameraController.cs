		...
		void OnGUI()
		{
			if ( showInstructions )
			{
				GUI.Label( new Rect( 10.0f, 10.0f, 600.0f, 400.0f ),
					...
					"Welcome to Pedro's Circus Game\n" +
					"Step 1. Go over all the objects to reveal their color.\n" +
					"Step 2. Store in your mind the color when you go over the object.\n" +
					"Step 3. Order objects.\n" +
					"From top left to right bottom: Blue,Yellow,White and Red.\n" +
					"Play until the music stops. Enjoy!\n" );
			}
		}
